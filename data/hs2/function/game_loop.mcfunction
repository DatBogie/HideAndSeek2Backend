...
execute if score STARTED hs2.timer matches -1 if score tick_end hs2.timer matches 40.. run function hs2:game_over
...
execute unless score Murder hs2.config matches 1.. if score count hs2.timer = HideTime hs2.config run function hs2:seeker_start
